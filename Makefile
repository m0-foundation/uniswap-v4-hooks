...
## Ethereum Mainnet
create-wm-usdc-liquidity-position-ethereum: RPC_URL=$(ETHEREUM_RPC_URL)
...
create-usdc-musd-liquidity-position-ethereum: RPC_URL=$(ETHEREUM_RPC_URL)
...
## Ethereum Mainnet
swap-usdc-to-wm-ethereum: RPC_URL=$(ETHEREUM_RPC_URL)
...
swap-usdc-to-musd-ethereum: RPC_URL=$(ETHEREUM_RPC_URL)
